...
if(!class_exists('subscribewidget')){
	class subscribewidget extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'widget Newsletter subscribe', 'description' => __('You can use this widget in sidebar and footer widget areas, can work in Subsiadary widget area in some themes too','supreme') );		
